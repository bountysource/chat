...
qwebirc.config.DEFAULT_OPTIONS = [
  [1, "BEEP_ON_MENTION", "Beep when nick mentioned or on query activity (requires Flash)", false, {
    enabled: function() {
  ...
  [7, "FLASH_ON_MENTION", "Flash titlebar when nick mentioned or on query activity", false, {
  ...
  [8, "LASTPOS_LINE", "Show a last position indicator for each window", false, {
    enabled: qwebirc.ui.supportsFocus
  }],
